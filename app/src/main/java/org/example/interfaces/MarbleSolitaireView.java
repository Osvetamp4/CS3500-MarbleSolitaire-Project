...
public interface MarbleSolitaireView {
   ...
   * @throws IOException if transmission of the board to the provided data destination fails (corporate ass dialogue)(This is a joke haha just a bit of whimsy)
   */
  ...
  /**
   * Prints out the destination field in org.example.MarbleSolitaireTextView.
   */
